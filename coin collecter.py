...
maze = pygame.image.load("python/coin collecter/images/pac_maze.png")
maze = scale_by(maze, 3)
maze_mask = pygame.mask.from_surface(maze)
coin_sheet_image = pygame.image.load("python/coin collecter/images/coin_sheet_no_bg.png").convert_alpha()
pac_sheet_image = pygame.image.load("python/coin collecter/images/pacman_sprite_sheet.png").convert_alpha()
